  ...
  return (
    <>
      <div className="flex flex-col justify-center">
        <main>
          <section className="flex flex-wrap gap-10 items-center px-64 py-40 w-full bg-gray-800">
            <div className="flex flex-col grow shrink items-start self-stretch pb-8 my-auto min-w-[240px] w-[525px]">
              <div className="flex z-10 shrink-0 mt-0 rounded border-solid border-[1.5px] border-zinc-400 h-[900px]" />
            </div>
            <div className="flex flex-col grow shrink self-stretch py-8 my-auto min-w-[240px] w-[525px]">
              <div className="flex flex-col w-full">
                <h2 className="text-xs font-semibold leading-none uppercase opacity-40 text-white text-opacity-90 tracking-[4px]">
                  It's great to meet you!
                </h2>
                <h1 className="mt-4 text-7xl font-extrabold leading-none text-yellow-600">
                  Hi, I'm Fr. Jack.
                </h1>
              </div>
              <div className="flex flex-col mt-8 w-full text-lg leading-9 text-white">
                <p>
          ...
          <section className="flex flex-wrap gap-10 py-40 pr-4 pl-64 w-full">
            <div className="flex flex-col py-8 my-auto min-w-[240px] w-[656px]">
              <div className="flex flex-col w-full">
                <h2 className="text-xs font-semibold leading-none uppercase opacity-40 text-zinc-700 tracking-[4px]">
                  Pray. Encounter. Share.
                </h2>
                <h3 className="mt-4 text-7xl font-extrabold text-yellow-600 leading-[76px]">
                  Encounter begins with a simple prayer.
                </h3>
              </div>
              <div className="flex flex-col mt-8 w-full text-lg leading-9 text-black">
                <p className="italic">
              ...
              <div className="flex gap-8 items-center self-start mt-8 text-lg leading-none text-white">
                <button className="gap-2.5 self-stretch px-8 py-4 my-auto bg-yellow-600 rounded">
                  Listen Now
                </button>
              </div>
            </div>
            <div className="flex flex-col flex-1 shrink pb-8 rounded basis-0 min-w-[240px]">
              <div className="flex z-10 shrink-0 mt-0 rounded border-solid border-[1.5px] border-zinc-400 h-[610px]" />
            </div>
          </section>
          <section className="flex overflow-hidden flex-wrap w-full text-white">
            <img
              loading="lazy"
              src={contactImageSrc}
              alt="Contact section background"
              className="object-contain flex-1 shrink py-48 w-full aspect-[1.41] basis-[248px] min-w-[240px]"
            />
            <div className="flex flex-col flex-1 shrink justify-center self-start px-32 py-48 bg-gray-800 basis-0 min-w-[240px]">
              <div className="flex flex-col w-full">
                <h2 className="text-xs font-semibold leading-none uppercase tracking-[4px]">
                  It's great to meet you!
                </h2>
                <h3 className="mt-6 text-6xl font-extrabold leading-[60px]">
